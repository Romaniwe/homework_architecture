...
## 2. Расчет нагрузки
   ...
   | Среднее число регистраций в день | 87.5 млн в месяц | WAU за февраль 2025 = 400 млн; WAU за Апрель-июнь уже 700-800 млн => Рост около 350 млн за 4 месяца => 350/4=87.5 млн в месяц новых юзеров | 
